            ...
            <div className="flex min-w-0 flex-1 flex-col">
                <header className="sticky top-0 z-30 flex items-center justify-between gap-3 bg-background px-4 py-4 lg:px-8">
                    ...
                    <div className="flex items-center gap-2">
                        <Link href="/" className="hidden items-center gap-1.5 rounded-full bg-muted px-4 py-2 text-sm font-medium sm:inline-flex">
    ...
    return (
        <>
            <div className="flex items-center justify-between px-5 py-5">
                ...
                {onClose && (
                    <button onClick={onClose} className="grid h-9 w-9 place-items-center rounded-full bg-primary-foreground/10" aria-label="Close menu">
                        <X className="h-4 w-4" />
                    </button>
                )}
            </div>
