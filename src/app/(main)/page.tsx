    ...
    <div>
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-24 text-primary-foreground lg:px-8 lg:py-36">
          <div className="max-w-2xl">
            ...
            <p className="mt-5 max-w-xl text-base opacity-95 sm:text-lg">
              Yam, cassava, tomatoes, pepper, grains and more — bought in bulk, ready for resellers, restaurants and markets.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <Link href="/shop" className="inline-flex items-center gap-2 rounded-full bg-primary-foreground px-6 py-3 text-sm font-semibold text-primary">
                Browse products <ArrowRight className="h-4 w-4" />
              </Link>
              <Link href="/whatsapp" className="inline-flex items-center gap-2 rounded-full bg-secondary px-6 py-3 text-sm font-semibold text-secondary-foreground">
      ...
      <section className="mx-auto max-w-7xl px-4 py-14 lg:px-8">
        <div className="grid gap-4 md:grid-cols-3">
          {[
            { icon: Truck, title: "Bulk delivery", body: "Sourced directly from farmers across all 16 regions of Ghana." },
            { icon: ShieldCheck, title: "Quality graded", body: "Every bag, crate and drum is sorted and graded before dispatch." },
            { icon: MessagesSquare, title: "Live pricing", body: "Join a regional WhatsApp group for daily price updates." },
          ].map((f) => (
      ...
      <section className="mx-auto max-w-7xl px-4 py-14 lg:px-8">
        <div className="flex items-end justify-between">
          ...
          <Link href="/shop" className="text-sm font-semibold text-primary">See all →</Link>
        </div>
          ...
          {categories.map((c: any) => (
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 p-5 text-primary-foreground">
                <div className="text-[10px] font-semibold uppercase tracking-widest opacity-80">Category</div>
                <div className="mt-1 text-lg font-bold leading-tight">{c.name}</div>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-16 lg:px-8">
        <div className="rounded-3xl bg-secondary p-10 text-secondary-foreground lg:p-14">
          <div className="grid gap-6 lg:grid-cols-2 lg:items-center">
            <div>
              <h2 className="text-2xl font-bold sm:text-3xl">Trade with your region</h2>
              <p className="mt-2 opacity-90">Join the Pomegrid WhatsApp group for your region and get daily updates on supply, price and delivery.</p>
            </div>
            <div className="flex justify-start lg:justify-end">
              <Link href="/whatsapp" className="rounded-full bg-secondary-foreground px-6 py-3 text-sm font-semibold text-secondary">
                Pick your region
              </Link>
            </div>
          </div>
